...
- **RAM Target:** Minimum **1GB RAM**, recommended **2GB RAM**. Do NOT target 512MB devices. However, still be mindful of memory — free image resources when not in use.
...
- **Entry Point:** `LockScreenPage.xaml` is the routing gateway. It checks `ScreenLocked` and navigates to either `LockScreen.xaml` (locked) or the editor page (unlocked). This file and its logic must NEVER be modified without explicit user permission.
...
### Project Architecture (MVC-like)

| Layer | Location | Responsibility |
|---|---|---|
| **Model** | `Models/` | Data classes, serialization, business logic |
...
| 2 | Bebas Neue | `/Assets/Fonts/BebasNeue-Regular.ttf#Bebas Neue` |
| 3 | Playfair Display | `/Assets/Fonts/PlayfairDisplay-Regular.ttf#Playfair Display` |
| 4 | DM Serif Display | `/Assets/Fonts/DMSerifDisplay-Regular.ttf#DM Serif Display` |
| 5 | Instrument Serif | `/Assets/Fonts/InstrumentSerif-Regular.ttf#Instrument Serif` |
| 6 | Montserrat Bold | `/Assets/Fonts/Montserrat-Bold.ttf#Montserrat` |
| 7 | Poppins SemiBold | `/Assets/Fonts/Poppins-SemiBold.ttf#Poppins` |
| 8 | Raleway Light | `/Assets/Fonts/Raleway-Light.ttf#Raleway` |
| 9 | Abril Fatface | `/Assets/Fonts/AbrilFatface-Regular.ttf#Abril Fatface` |
| 10 | Segoe WP | (System font) |
| 11 | Segoe WP Black | (System font) |
